...
import {
  ...
  addTaskCommentApi,
  getSubTaskListApi,
} from "@/api/paih-project/my-task.js"
import { getProjectListApi } from "@/api/dashboard/index.js"
import { getStageListApi, getFileListApi, deleteFileApi } from "@/api/paih-project/my-project.js"
...
export default {
  ...
  methods: {
    ...
    clickSubTask(taskId, taskName) {
      // this.$tab.openPage(`子任务-${taskName}`, `/paih-project/my-task/child/info?taskId=${taskId}`)
      this.$router.push({ path: "/paih-project/my-task/child/info", query: { taskId: taskId } })
    },
