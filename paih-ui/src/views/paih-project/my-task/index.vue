...
import { getTaskListApi, deleteTaskApi } from "@/api/paih-project/my-task.js"
import { getProjectListApi } from "@/api/dashboard/index.js"
import { getStageListApi, getProjectTaskListApi } from "@/api/paih-project/my-project.js"
...
export default {
  ...
  methods: {
    ...
    handleInfo(row) {
      this.$router.push({ path: "/paih-project/my-task/info", query: { taskId: row.taskId } })
    },
    handleDelete(row) {
      const data = {
