          ...
          <el-col :span="12">
                <el-form-item prop="providerCategoryId" label="类别">
                  ...
                  <div style="display: flex">
                    ...
                    />
                    <router-link to="/pmhub-purchase/provider-sort">
...
import {
  ...
  getCodeByType,
} from "@/api/pmhub-purchase/provider-manage.js"
import { listProviderSort } from "@/api/pmhub-purchase/provider-sort.js"
...
export default {
  ...
  data() {
    return {
      ...
      upload: {
        ...
        // 上传的地址
        url: process.env.VUE_APP_BASE_API + "/pmhub-purchase/providerManage/importData",
      },
      // 表单校验
      rules: {
        providerName: [
  ...
  methods: {
    ...
    /** 下载模板操作 */
    importTemplate() {
      this.download("pmhub-purchase/providerManage/importTemplate", {}, `provider_template_${new Date().getTime()}.xlsx`)
    },
    // 文件上传中处理
    ...
    handleExport() {
      ...
      this.download(
        "/pmhub-purchase/providerManage/export",
