package com.laigeoffer.projectaihub.oa.oa.consumer;
...
import com.laigeoffer.projectaihub.oa.domain.workWx.dto.body.action.*;
...
import com.laigeoffer.projectaihub.oa.domain.workWx.dto.body.result.ProcessReturnDTO;
import com.laigeoffer.projectaihub.oa.utils.MessageDataDTO;
import com.laigeoffer.projectaihub.oa.utils.RedisUtils;
...
public class OAMessageConsumer implements CommandLineRunner {
     ...
     * 微信topic
     * */
//    @Value("${projectaihub.rocketMQ.topic.wxMessage}")
     ...
     * 服务器地址
     * */
//    @Value("${projectaihub.rocketMQ.addr}")
    private String addr;
     ...
     * 消费组
     * */
//    @Value("${projectaihub.rocketMQ.topic.consumerGroup}")
