...
import com.laigeoffer.projectaihub.common.enums.FileTypeEnum;
...
import com.laigeoffer.projectaihub.project.mapper.ProjectMemberMapper;
...
public class ProjectFileServiceImpl extends ServiceImpl<ProjectFileMapper, ProjectFile> implements ProjectFileService {
    ...
    public void rename(ProjectFileReqVO projectFileReqVO) {
        ...
        // D:/paih-manage/uploadPath/project/admin/20221229/s1iqii2engq.jpg
