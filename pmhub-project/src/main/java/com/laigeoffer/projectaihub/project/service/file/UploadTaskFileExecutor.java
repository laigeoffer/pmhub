...
import com.laigeoffer.projectaihub.project.mapper.ProjectFileMapper;
...
public class UploadTaskFileExecutor extends UploadAbstractExecutor {
    ...
    public FileVO upload(LoginUser user, MultipartFile file, String id) throws Exception {
        ...
        String taskPath = FileUploadUtils.uploadTaskFile(ProjectaihubConfig.getTaskPath(), file, MimeTypeUtils.DEFAULT_ALLOWED_EXTENSION);
        String pn = FileUploadUtils.getPathName(ProjectaihubConfig.getTaskPath(), file);
