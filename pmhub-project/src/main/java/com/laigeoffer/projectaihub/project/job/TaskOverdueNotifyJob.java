...
import com.laigeoffer.projectaihub.project.domain.vo.project.task.TaskNotifyDTO;
                ...
                .forEach(taskNotifyDTO -> {
                    ...
                    if (ChronoUnit.DAYS.between(localDate, closeDate) < 0L) {
                        ...
                        if (projectTaskNotify == null) {
                            ...
                            // 设置任务详情页
                            String url = SsoUrlUtils.ssoCreate(appid, agentid, host + path + ssoPath + URLEncoder.encode(host + "/paih-project/my-task/info?taskId=" + taskNotifyDTO.getTaskId()));
                            ...
                            taskOvertimeRemindDTO.setLinkUrl(OAUtils.ssoCreate(host + "/paih-project/my-task/info?taskId=" + taskNotifyDTO.getTaskId()));
