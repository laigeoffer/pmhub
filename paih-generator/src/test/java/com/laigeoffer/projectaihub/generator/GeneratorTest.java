package com.laigeoffer.projectaihub.generator;
...
import com.laigeoffer.projectaihub.common.core.domain.BaseCoreEntity;
...
public class GeneratorTest {
    ...
    /** 1、数据源配置（开发or测试环境）  */
    // url
    private final static String DATASOURCE_URL = "jdbc:mysql://47.109.46.103:5506/paih-manage?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=true&serverTimezone=GMT%2B8";
    ...
    // 模块名称
    private final static String MODULE = "paih-" + YOUR_MODULE;
    ...
    /** 3、包配置(包名主要给模板引用)  */
    // 父包名
    private final static String PARENT = "com.laigeoffer.projectaihub." + YOUR_MODULE;

    // controller包名
    private final static String PACK_CONTROLLER = "com.laigeoffer.projectaihub.web.controller." + YOUR_MODULE;
    ...
    private final static String PATH_CONTROLLER = PROJECTPATH +  "/paih-admin/src/main/java/com/paih/web/controller/" + YOUR_MODULE;

    // service、serviceImpl、dto、vo、entity、mapper存储路径
    private final static String PATH_COMMON = PROJECTPATH + "/"  + MODULE +  "/src/main/java/com/paih/" + YOUR_MODULE;
    ...
    private final static String TABLE_PREFIX = "paih_";
