...
import com.laigeoffer.projectaihub.project.service.ProjectFileService;
import com.laigeoffer.projectaihub.project.service.file.UploadFileFactory;
...
import static com.laigeoffer.projectaihub.common.core.domain.AjaxResult.error;
import static com.laigeoffer.projectaihub.common.utils.SecurityUtils.getLoginUser;
...
public class ProjectFileController {
    ...
    public AjaxResult downloadFileList(@RequestParam("projectFileIds") String projectFileIds, HttpServletResponse response) {
        ...
        String totalZip = ProjectaihubConfig.getProfile() + "/tmp.zip";
