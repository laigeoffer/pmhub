package com.laigeoffer.projectaihub.common.utils.file;
...
import com.laigeoffer.projectaihub.common.exception.file.FileNameLengthLimitExceededException;
import com.laigeoffer.projectaihub.common.exception.file.FileSizeLimitExceededException;
...
public class FileUploadUtils {
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = ProjectaihubConfig.getProfile();
    ...
    public static final String getPathFileName(String uploadDir, String fileName) throws IOException {
        int dirLastIndex = ProjectaihubConfig.getProfile().length() + 1;
