package com.laigeoffer.projectaihub.common.utils;
...
public class OAUtils {
    ...
    @Value("${projectaihub.oa.appId}")
    private void setAppId(String appId) {
        OAUtils.APPID = appId;
    }
    @Value("${projectaihub.oa.code}")
    private void setCode(String code) {
        OAUtils.CODE = code;
    }


    @Value("${projectaihub.oa.clientId}")
    private void setClientId(String clientId) {
        OAUtils.CLIENT_ID = clientId;
    }

    @Value("${projectaihub.oa.clientSecret}")
    ...
    @Value("${projectaihub.oa.host}")
    private void setHost(String host) {
        OAUtils.host = host;
    }

    /**
     * projectaihub平台 path2
     * */
    public static String path2;
    @Value("${projectaihub.oa.path2}")
