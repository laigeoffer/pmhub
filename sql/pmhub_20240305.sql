...
-- ----------------------------
BEGIN;
INSERT INTO `sys_job` (`job_id`, `job_name`, `job_group`, `invoke_target`, `cron_expression`, `misfire_policy`, `concurrent`, `status`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (1, '系统默认（无参）', 'DEFAULT', 'ryTask.ryNoParams', '0/10 * * * * ?', '3', '1', '1', 'admin', '2022-12-06 17:32:35', '', NULL, ''), (2, '系统默认（有参）', 'DEFAULT', 'ryTask.ryParams(\'ry\')', '0/15 * * * * ?', '3', '1', '1', 'admin', '2022-12-06 17:32:35', '', NULL, ''), (3, '系统默认（多参）', 'DEFAULT', 'ryTask.ryMultipleParams(\'ry\', true, 2000L, 316.50D, 100)', '0/20 * * * * ?', '3', '1', '1', 'admin', '2022-12-06 17:32:35', '', NULL, ''), (4, '任务待逾期提醒', 'DEFAULT', 'com.sxsd.quartz.task.TaskNotifyTask.taskNotify()', '0 0 9 * * ?', '1', '1', '1', 'admin', '2023-10-12 09:50:01', '', NULL, ''), (5, '任务已逾期提醒', 'DEFAULT', 'com.sxsd.quartz.task.TaskOverdueNotifyTask.taskNotify()', '0 0 9 * * ?', '1', '1', '1', 'admin', '2023-10-12 09:57:14', '', NULL, ''), (6, '任务已逾期状态修改', 'DEFAULT', 'com.sxsd.quartz.task.TaskOverdueStatusTask.taskNotify()', '0 0 1 * * ?', '1', '1', '1', 'admin', '2023-10-12 09:58:12', '', NULL, ''), (7, '任务已逾期周提醒', 'DEFAULT', 'com.sxsd.quartz.task.TaskOverdueWeekNotifyTask.taskNotify()', '0 0 10 ? * MON', '1', '1', '1', 'admin', '2023-10-12 09:59:12', '', NULL, ''), (8, '代办任务提醒', 'DEFAULT', 'com.sxsd.quartz.task.TodoRemindTask.sayWord()', '0 0 9 1/2 * ?', '1', '1', '1', 'admin', '2023-10-12 10:00:24', '', NULL, ''), (9, '计算物料批次存量', 'DEFAULT', 'com.sxsd.quartz.task.MaterialsCountCalcTask.countCalc()', '0 0 3 * * ?', '1', '1', '1', 'admin', '2023-10-12 10:08:14', '', NULL, ''), (10, '计算分类编码头', 'DEFAULT', 'com.sxsd.quartz.task.MaterialsTypeCodeHeadCalcTask.countCalc()', '0 0 1 1 * ?', '1', '1', '1', 'admin', '2023-10-12 10:09:15', 'lisi', '2023-10-23 16:31:03', '');
COMMIT;
