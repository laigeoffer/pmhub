...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='离线任务';
...
CREATE TABLE `pmhub_document_data` (
                                       ...
                                       `module_type` int DEFAULT NULL COMMENT '模块类型',
...
CREATE TABLE `pmhub_document_type` (
                                       ...
                                       PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='单据分类';
...
CREATE TABLE `pmhub_materials` (
                                   ...
                                   `code` int DEFAULT NULL COMMENT '五级代码-物料流水编号',
                                   ...
                                   `quality_guarantee_period` int DEFAULT NULL COMMENT '质保期（天）',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='物料明细';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='已允许单点登录的用户及对应应用';
...
CREATE TABLE `pmhub_project` (
                                 ...
                                 `user_id` bigint DEFAULT NULL COMMENT '项目负责人',
...
CREATE TABLE `pmhub_project_collection` (
                                            ...
                                            `user_id` bigint DEFAULT NULL COMMENT '用户id',
                                            PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='项目-收藏表';
...
CREATE TABLE `pmhub_project_file` (
                                      ...
                                      PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='项目或任务附件表';
...
CREATE TABLE `pmhub_project_log` (
                                     ...
                                     `project_id` varchar(64) NOT NULL COMMENT '项目id',
                                     PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='项目-任务日志';
...
CREATE TABLE `pmhub_project_member` (
                                        ...
                                        PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='项目-任务成员';
...
CREATE TABLE `pmhub_project_stage` (
                                       ...
                                       `updated_time` datetime DEFAULT NULL COMMENT '更新时间',
                                       PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='项目阶段';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='项目-任务表';
...
CREATE TABLE `pmhub_project_task_notify` (
                                             ...
                                             PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='任务提醒表';
...
CREATE TABLE `pmhub_project_task_work_time` (
                                                ...
                                                `updated_time` datetime DEFAULT NULL,
                                                PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='任务工时表';
...
CREATE TABLE `pmhub_public_file` (
                                     ...
                                     `deleted` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否删除 0-否 1-删除',
                                     PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='不指定目标的上传文件';
...
CREATE TABLE `pmhub_public_file_cache` (
                                           ...
                                           `deleted` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否删除 0-否 1-删除',
                                           PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='不指定目标的上传文件缓存表';
...
CREATE TABLE `pmhub_public_file_link` (
                                          ...
                                          `deleted` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否删除 0-否 1-删除',
                                          PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='文件引用关联表，所有未指定关系的上传文件都应该在这里指定关联关系，如果有文件在这个关联表中没有任何关联关系，则会被定时任务物理删除';
...
CREATE TABLE `pmhub_template` (
                                  ...
                                  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='模板文件';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='用户发起取消流程';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='流程表单信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=217 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='部门表';
...
) ENGINE=InnoDB AUTO_INCREMENT=9025 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='系统访问记录';
...
) ENGINE=InnoDB AUTO_INCREMENT=2171 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='菜单权限表';
...
) ENGINE=InnoDB AUTO_INCREMENT=13237 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='操作日志记录';
...
) ENGINE=InnoDB AUTO_INCREMENT=115 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='角色信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=174 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='用户信息表';
