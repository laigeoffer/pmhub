...
import com.laigeoffer.projectaihub.common.enums.ProjectTaskPriorityEnum;
...
import com.laigeoffer.projectaihub.oa.domain.workWx.dto.body.notice.TaskAssignRemindDTO;
import com.laigeoffer.projectaihub.oa.utils.SsoUrlUtils;
import com.laigeoffer.projectaihub.project.domain.*;
import com.laigeoffer.projectaihub.project.domain.vo.project.ProjectVO;
import com.laigeoffer.projectaihub.project.domain.vo.project.log.*;
import com.laigeoffer.projectaihub.project.domain.vo.project.member.ProjectMemberResVO;
import com.laigeoffer.projectaihub.project.domain.vo.project.task.*;
import com.laigeoffer.projectaihub.project.mapper.*;
import com.laigeoffer.projectaihub.project.service.ProjectLogService;
import com.laigeoffer.projectaihub.project.service.ProjectTaskService;
import com.laigeoffer.projectaihub.project.service.task.QueryTaskLogFactory;
...
public class ProjectTaskServiceImpl extends ServiceImpl<ProjectTaskMapper, ProjectTask> implements ProjectTaskService {
    ...
    private void extracted(String taskName, Long userId, String username, String taskId) {
        ...
        if (StringUtils.isNotBlank(name)) {
            ...
            // 设置任务详情地址
            String url = SsoUrlUtils.ssoCreate(appid, agentid, host + path + ssoPath + URLEncoder.encode(host + "/paih-project/my-task/info?taskId=" + taskId));
            ...
            taskAssignRemindDTO.setLinkUrl(OAUtils.ssoCreate(host + "/paih-project/my-task/info?taskId=" + taskId));
...
//            RocketMqUtils.push2Wx(taskAssignRemindDTO);
    ...
    public void downloadTaskTemplate(HttpServletResponse response) throws IOException {
        String filePath = ProjectaihubConfig.getProfile() + "/template/taskTemplate.xlsx";
        response.setContentType(MediaType.APPLICATION_OCTET_STREAM_VALUE);
